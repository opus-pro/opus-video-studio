# Multi-Line Headline Snap

Snap complete headline rows in and switch to a second statement. Best for: Campaign headlines and title cards.

[Gallery](https://product-videos.labs.opus.pro/pf-type-snap) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-type-snap-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Multi-Line Headline Snap video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-type-snap-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-type-snap-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-type-snap
cd templates/pf-type-snap/project
npm ci
npm run verify
npm run check
npm run studio
