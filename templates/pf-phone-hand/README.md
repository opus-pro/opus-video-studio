...
Place an editable product flow precisely inside a photographed phone. Best for: Mobile product demos and app launches.

[Gallery](https://product-videos.labs.opus.pro/pf-phone-hand) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-hand-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch In-Hand App Scroll video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-hand-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-hand-v1.0.0/preview.mp4)

Motion component · 4.6 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- pf-phone-hand
cd templates/pf-phone-hand/project
npm ci
npm run verify
npm run check
npm run studio
