# Three-Ribbon Campaign

Set three opposing type ribbons into a compact campaign lockup. Best for: Launches, events, and bold announcements.

[Gallery](https://product-videos.labs.opus.pro/template-ribbon-manifesto) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-ribbon-manifesto-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Three-Ribbon Campaign video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-ribbon-manifesto-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-ribbon-manifesto-v1.0.0/preview.mp4)

Motion component · 8 seconds · 30 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-ribbon-manifesto
cd templates/template-ribbon-manifesto/project
npm ci
npm run verify
npm run check
npm run studio
