...
Character chat and personal assistants Best for: Character chat and personal assistants.

[Gallery](https://product-videos.labs.opus.pro/ai-companion) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/ai-companion-motion-template-lite-v12-1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch AI Companion video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/ai-companion-motion-template-lite-v12-1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/ai-companion-motion-template-lite-v12-1.0.0/preview.mp4)

Full video template · 30 seconds · 30 fps · release 1.0.0 (v12).
...
```sh
npm run templates:prepare -- ai-companion
cd templates/ai-companion/project
npm ci
npm run check
npm run studio
```
