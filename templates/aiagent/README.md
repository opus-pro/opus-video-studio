...
Ideas to software with fluid UI motion Best for: AI coding agents and software creation workflows.

[Gallery](https://product-videos.labs.opus.pro/aiagent) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/aiagent-motion-template-lite-1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch AI Coding Agent video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/aiagent-motion-template-lite-1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/aiagent-motion-template-lite-1.0.0/preview.mp4)

Full video template · 28.1333 seconds · 60 fps · release 1.0.0 (v2-smooth60).
...
```sh
npm run templates:prepare -- aiagent
cd templates/aiagent/project
npm ci
npm run verify
npm run check
npm run studio
