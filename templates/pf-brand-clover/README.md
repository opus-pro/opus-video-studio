# Logo Unfold Brand System

Unfold a four-part mark into a complete modular brand world. Best for: Logo stories and identity presentations.

[Gallery](https://product-videos.labs.opus.pro/pf-brand-clover) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-clover-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Logo Unfold Brand System video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-clover-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-clover-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-brand-clover
cd templates/pf-brand-clover/project
npm ci
npm run verify
npm run check
npm run studio
