...
Ask a question and reveal an answer with visible source evidence. Best for: Research assistants and knowledge products.

[Gallery](https://product-videos.labs.opus.pro/template-case-research) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-research-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Evidence-Backed Answer video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-research-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-research-v1.0.0/preview.mp4)

Motion component · 8.4 seconds · 30 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-case-research
cd templates/template-case-research/project
npm ci
npm run verify
npm run check
npm run studio
