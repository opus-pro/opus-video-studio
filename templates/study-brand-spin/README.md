...
Resolve a symbol with one controlled half-turn. Best for: Short logo stings.

[Gallery](https://product-videos.labs.opus.pro/study-brand-spin) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-spin-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Logo Half Turn video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-spin-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-spin-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- study-brand-spin
cd templates/study-brand-spin/project
npm ci
npm run verify
npm run check
npm run studio
