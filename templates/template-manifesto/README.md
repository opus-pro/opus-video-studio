...
Expand one quiet sentence into a polished multi-line brand manifesto. Best for: Brand stories and premium title sequences.

[Gallery](https://product-videos.labs.opus.pro/template-manifesto) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-manifesto-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Glossy Serif Manifesto video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-manifesto-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-manifesto-v1.0.0/preview.mp4)

Motion component · 9 seconds · 30 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-manifesto
cd templates/template-manifesto/project
npm ci
npm run verify
npm run check
npm run studio
