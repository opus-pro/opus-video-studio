# Horizontal Portfolio Relay

Pass four editorial posters through one horizontal hero position. Best for: Portfolios, collections, and case studies.

[Gallery](https://product-videos.labs.opus.pro/pf-carousel-horizontal) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-horizontal-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Horizontal Portfolio Relay video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-horizontal-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-horizontal-v1.0.0/preview.mp4)

Motion component · 4.8 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- pf-carousel-horizontal
cd templates/pf-carousel-horizontal/project
npm ci
npm run verify
npm run check
npm run studio
