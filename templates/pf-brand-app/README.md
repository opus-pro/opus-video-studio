# App Icon to Brand System

Open an app icon into a complete five-panel identity system. Best for: App launches and visual identity.

[Gallery](https://product-videos.labs.opus.pro/pf-brand-app) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-app-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch App Icon to Brand System video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-app-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-app-v1.0.0/preview.mp4)

Motion component · 5.8 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- pf-brand-app
cd templates/pf-brand-app/project
npm ci
npm run verify
npm run check
npm run studio
