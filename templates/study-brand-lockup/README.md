...
Shrink a centered symbol and reveal its brand name. Best for: Minimal logo reveals.

[Gallery](https://product-videos.labs.opus.pro/study-brand-lockup) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-lockup-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Symbol to Wordmark video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-lockup-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-lockup-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- study-brand-lockup
cd templates/study-brand-lockup/project
npm ci
npm run verify
npm run check
npm run studio
