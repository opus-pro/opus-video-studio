# Trail Recap Data Reveal

Turn a landscape into a route trace and a clean performance recap. Best for: Fitness, travel, and achievement stories.

[Gallery](https://product-videos.labs.opus.pro/pf-trail-recap) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-trail-recap-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Trail Recap Data Reveal video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-trail-recap-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-trail-recap-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-trail-recap
cd templates/pf-trail-recap/project
npm ci
npm run verify
npm run check
npm run studio
