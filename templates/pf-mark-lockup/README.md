...
Move a centered app mark aside and reveal a complete wordmark lockup. Best for: Logo reveals and brand idents.

[Gallery](https://product-videos.labs.opus.pro/pf-mark-lockup) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-mark-lockup-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Icon-to-Wordmark Reveal video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-mark-lockup-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-mark-lockup-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-mark-lockup
cd templates/pf-mark-lockup/project
npm ci
npm run verify
npm run check
npm run studio
