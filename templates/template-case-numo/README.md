...
Trace one data anomaly into an understandable recommendation. Best for: Analytics products and insight workflows.

[Gallery](https://product-videos.labs.opus.pro/template-case-numo) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-numo-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Anomaly to Action video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-numo-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-numo-v1.0.0/preview.mp4)

Motion component · 10.2 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-case-numo
cd templates/template-case-numo/project
npm ci
npm run verify
npm run check
npm run studio
