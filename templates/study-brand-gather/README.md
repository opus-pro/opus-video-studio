# Four Blocks Converge

Gather four moving blocks into one central mark. Best for: Logo assembly and brand stings.

[Gallery](https://product-videos.labs.opus.pro/study-brand-gather) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-gather-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Four Blocks Converge video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-gather-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-gather-v1.0.0/preview.mp4)

Motion component · 2.2 seconds · 30 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- study-brand-gather
cd templates/study-brand-gather/project
npm ci
npm run verify
npm run check
npm run studio
