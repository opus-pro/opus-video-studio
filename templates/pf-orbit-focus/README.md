...
Orbit equal-size images around a statement, then bring one through camera. Best for: Spatial showreels and hero reveals.

[Gallery](https://product-videos.labs.opus.pro/pf-orbit-focus) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-focus-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch 3D Orbit to Hero video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-focus-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-focus-v1.0.0/preview.mp4)

Motion component · 6 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- pf-orbit-focus
cd templates/pf-orbit-focus/project
npm ci
npm run verify
npm run check
npm run studio
