# Live Website Restyle

Change one color control and let the entire page respond. Best for: Website builders and visual editors.

[Gallery](https://product-videos.labs.opus.pro/template-case-website) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-website-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Live Website Restyle video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-website-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-case-website-v1.0.0/preview.mp4)

Motion component · 6.5 seconds · 30 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-case-website
cd templates/template-case-website/project
npm ci
npm run verify
npm run check
npm run studio
