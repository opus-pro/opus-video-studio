# Five-Point Brand System

Turn five color points into a living modular identity board. Best for: Identity systems and brand launches.

[Gallery](https://product-videos.labs.opus.pro/pf-brand-dots) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-dots-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Five-Point Brand System video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-dots-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-brand-dots-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-brand-dots
cd templates/pf-brand-dots/project
npm ci
npm run verify
npm run check
npm run studio
