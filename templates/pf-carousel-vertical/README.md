# Vertical Portfolio Relay

Pass four editorial posters through one vertical hero position. Best for: Mobile collections and vertical showcases.

[Gallery](https://product-videos.labs.opus.pro/pf-carousel-vertical) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-vertical-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Vertical Portfolio Relay video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-vertical-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-vertical-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-carousel-vertical
cd templates/pf-carousel-vertical/project
npm ci
npm run verify
npm run check
npm run studio
