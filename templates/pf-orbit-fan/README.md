...
Rotate a grounded fan of posters and promote one work at a time. Best for: Artwork, covers, and portfolio reels.

[Gallery](https://product-videos.labs.opus.pro/pf-orbit-fan) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-fan-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Fan Deck Showcase video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-fan-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-orbit-fan-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-orbit-fan
cd templates/pf-orbit-fan/project
npm ci
npm run verify
npm run check
npm run studio
