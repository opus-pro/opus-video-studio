# Dithered Event Poster

Resolve a multi-line title through a deterministic pixel mask. Best for: Event posters and graphic announcements.

[Gallery](https://product-videos.labs.opus.pro/pf-pixel-poster) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-pixel-poster-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Dithered Event Poster video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-pixel-poster-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-pixel-poster-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-pixel-poster
cd templates/pf-pixel-poster/project
npm ci
npm run verify
npm run check
npm run studio
