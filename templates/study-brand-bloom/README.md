...
Rotate and unfold a compact mark into its final silhouette. Best for: Brand marks and idents.

[Gallery](https://product-videos.labs.opus.pro/study-brand-bloom) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-bloom-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Logo Bloom video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-bloom-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-study-brand-bloom-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- study-brand-bloom
cd templates/study-brand-bloom/project
npm ci
npm run verify
npm run check
npm run studio
