# 3D Diagonal Portfolio Relay

Move equal-size poster planes around a true diagonal 3D loop. Best for: Dimensional portfolios and spatial showreels.

[Gallery](https://product-videos.labs.opus.pro/pf-carousel-diagonal) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-diagonal-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch 3D Diagonal Portfolio Relay video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-diagonal-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-carousel-diagonal-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-carousel-diagonal
cd templates/pf-carousel-diagonal/project
npm ci
npm run verify
npm run check
npm run studio
