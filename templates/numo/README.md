...
Data analytics Best for: Data analytics.

[Gallery](https://product-videos.labs.opus.pro/numo) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/numo-motion-template-lite-1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Analytics Dashboard video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/numo-motion-template-lite-1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/numo-motion-template-lite-1.0.0/preview.mp4)

Full video template · 15 seconds · 60 fps · release 1.0.0 (4d).
...
```sh
npm run templates:prepare -- numo
cd templates/numo/project
npm ci
npm run check
npm run studio
```
