...
Drive equal-size image planes through a true perspective spiral tunnel. Best for: Immersive showreels and central statements.

[Gallery](https://product-videos.labs.opus.pro/pf-depth-swirl) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-depth-swirl-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch 3D Depth Spiral video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-depth-swirl-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-depth-swirl-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-depth-swirl
cd templates/pf-depth-swirl/project
npm ci
npm run verify
npm run check
npm run studio
