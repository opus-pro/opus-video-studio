# Growing Analytics Capsules

Grow luminous data capsules into a compact analytics result. Best for: Metrics, dashboards, and proof points.

[Gallery](https://product-videos.labs.opus.pro/template-analytics-glow) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-analytics-glow-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Growing Analytics Capsules video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-analytics-glow-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-template-analytics-glow-v1.0.0/preview.mp4)

Motion component · 3 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- template-analytics-glow
cd templates/template-analytics-glow/project
npm ci
npm run verify
npm run check
npm run studio
