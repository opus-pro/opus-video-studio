...
Reveal and replace brand lines over a continuous procedural color field. Best for: Brand films and colorful announcements.

[Gallery](https://product-videos.labs.opus.pro/pf-color-field) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-color-field-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Flowing Color Field video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-color-field-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-color-field-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-color-field
cd templates/pf-color-field/project
npm ci
npm run verify
npm run check
npm run studio
