# Editorial Print Launch

Relay three art prints through one graphic product-launch composition. Best for: Art drops, editions, and product series.

[Gallery](https://product-videos.labs.opus.pro/pf-print-menu) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-print-menu-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Editorial Print Launch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-print-menu-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-print-menu-v1.0.0/preview.mp4)

Motion component · 5.6 seconds · 60 fps · release 1.1.0 (editable-source-v1.1.0).
...
```sh
npm run templates:prepare -- pf-print-menu
cd templates/pf-print-menu/project
npm ci
npm run verify
npm run check
npm run studio
