# Portrait Slice Assembly

Assemble four cinematic portrait slices into one macro campaign image. Best for: Portrait campaigns and editorial reveals.

[Gallery](https://product-videos.labs.opus.pro/pf-portrait-slices) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-portrait-slices-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Portrait Slice Assembly video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-portrait-slices-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-portrait-slices-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-portrait-slices
cd templates/pf-portrait-slices/project
npm ci
npm run verify
npm run check
npm run studio
