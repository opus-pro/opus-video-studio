# Three-Phone Carousel

Rotate three complete phone states through the central product position. Best for: Feature tours and mobile app showcases.

[Gallery](https://product-videos.labs.opus.pro/pf-phone-carousel) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-carousel-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Three-Phone Carousel video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-carousel-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-phone-carousel-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-phone-carousel
cd templates/pf-phone-carousel/project
npm ci
npm run verify
npm run check
npm run studio
