# Headline to Event Pass

Transform a three-line announcement into a finished event credential. Best for: Events, conferences, and invitations.

[Gallery](https://product-videos.labs.opus.pro/pf-event-pass) · [Watch video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-event-pass-v1.0.0/preview.mp4) · [Editable source](project/) · [Original package notes](project/README.md)

[![Watch Headline to Event Pass video demo](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-event-pass-v1.0.0/poster.jpg)](https://opus-lab.cdn.opuslab.ai/labs/launch-videos/lite/motion-component-pf-event-pass-v1.0.0/preview.mp4)
...
```sh
npm run templates:prepare -- pf-event-pass
cd templates/pf-event-pass/project
npm ci
npm run verify
npm run check
npm run studio
