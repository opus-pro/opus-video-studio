# Task: Vertical Portfolio Relay (`pf-carousel-vertical`)
...
- `src/index.tsx` registers composition `pf-carousel-vertical` at 1200x1200, 60 fps, 288 frames. Keep those exactly; put the implementation in `src/` (any number of files).
...
- Final: `node scripts/render.mjs` renders `out/pf-carousel-vertical.mp4`.
